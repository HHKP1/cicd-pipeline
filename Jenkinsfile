            ...
            steps {
                script {
                    if (env.BRANCH_NAME == 'main') {
                        ...
                        dockerBuildStep(this, env.registry, 'Dockerfile.tpl', 'nodemain', 'v1.0', '7.8.0-alpine', 3000)
                    } else if (env.BRANCH_NAME == 'dev' ) {
                        sh "mv src/orange_logo.svg src/logo.svg"
                        dockerBuildStep(this, env.registry, 'Dockerfile.tpl', 'nodedev', 'v1.0', '7.8.0-alpine', 3001)
                    }
